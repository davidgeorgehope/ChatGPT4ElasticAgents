...
if __name__ == "__main__":
    ...
    elastic_messages = [{"role": "system", "content": 'From this prompt forward I want you to generate elasticsearch queries to help me with my request. Do not provide any commentary, just a query. Note that exceptions can be found by checking for messages with Exception in them'}]
